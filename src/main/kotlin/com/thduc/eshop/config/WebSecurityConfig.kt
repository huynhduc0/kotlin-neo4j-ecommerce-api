...
//            .antMatchers("/error/**").permitAll()
            ...
            .antMatchers(HttpMethod.GET,"/rating/execute").permitAll()
            .antMatchers(HttpMethod.GET,"/rating/setSys/**/**").permitAll()
            .antMatchers(HttpMethod.GET,"/rating/summary").permitAll()
